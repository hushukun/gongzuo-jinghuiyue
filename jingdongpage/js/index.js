$(function () {
    ...
    var timer1 = setInterval(function () {
        current++;
        if (current > $("#banner-img1 li").length - 1) {
            current = 0;
        }
        $("#banner-img1 li").eq(current).fadeIn(500).siblings("li").fadeOut(500)
    }, 5000)
    ...
    if (document.cookie) {
        ...
        $("#cookieBtn").click(function () {
            $.removeCookie('username', { path: '/jingdongpage/' })
            $.removeCookie('avatar', { path: '/jingdongpage/' })
